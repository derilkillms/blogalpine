...
<div class="container mx-auto px-4">
  <div x-data="{ detail: [], currentPage: 1, perPage: 9 }" x-init="
  fetch('data.json')
...
">
<div class="p-10 mt-20 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5">
  <template x-for="item in detail.slice((currentPage - 1) * perPage, currentPage * perPage)">

    <!-- <div x-text="item.name"></div> -->

    <div class="rounded overflow-hidden shadow-lg">
      <img class="w-full" :src="item.image" alt="Post Image">
      <div class="px-6 py-4">
        <div class="font-bold text-xl mb-2" x-text="item.name">

        </div>
        <p class="text-gray-700 text-base" x-text="item.post">
